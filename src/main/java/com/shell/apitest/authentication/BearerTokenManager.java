...
public class BearerTokenManager extends HeaderAuth implements BearerTokenCredentials {
     ...
     * Constructor.
     */
    public BearerTokenManager(BearerTokenModel authModel) {
    ...
    */
    ...
    /**
     * Converts this BearerTokenManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BearerTokenManager [" + "oAuthClientId=" + getOAuthClientId()
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenBearerTokenAsync(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenBearerToken(
            getBasicAuthForClient(),
            null,
            aparams);
