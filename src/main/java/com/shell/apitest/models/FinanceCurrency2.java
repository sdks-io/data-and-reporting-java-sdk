...
/**
 * This is a model class for FinanceCurrency2 type.
 */
public class FinanceCurrency2 {
    ...
    protected FinanceCurrency2(OptionalNullable<String> currencyCode,
    ...
    /**
     * Converts this FinanceCurrency2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "FinanceCurrency2 [" + "currencyCode=" + currencyCode + ", currencySymbol="
                + currencySymbol + ", invoiceExchangeRate=" + invoiceExchangeRate
                + ", creditLimitExchangeRate=" + creditLimitExchangeRate + "]";
    }

    /**
     * Builds a new {@link FinanceCurrency2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link FinanceCurrency2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link FinanceCurrency2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link FinanceCurrency2} object using the set fields.
         * @return {@link FinanceCurrency2}
         */
        public FinanceCurrency2 build() {
            return new FinanceCurrency2(currencyCode, currencySymbol, invoiceExchangeRate,
