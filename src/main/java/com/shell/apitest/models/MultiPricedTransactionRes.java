...
/**
 * This is a model class for MultiPricedTransactionRes type.
 */
public class MultiPricedTransactionRes {
    private String requestId;
    private String status;
    private List<MultiPricedTransactionResponse> data;
     ...
     * Default constructor.
     */
    public MultiPricedTransactionRes() {
    }
     ...
     * @param  data  List of MultiPricedTransactionResponse value for data.
    ...
    public MultiPricedTransactionRes(
            String requestId,
            String status,
            List<MultiPricedTransactionResponse> data,
            Integer page,
    ...
    /**
     * Getter for Data.
     * @return Returns the List of MultiPricedTransactionResponse
     */
    @JsonGetter("Data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<MultiPricedTransactionResponse> getData() {
        return data;
    }

    /**
     * Setter for Data.
     * @param data Value for List of MultiPricedTransactionResponse
     */
    @JsonSetter("Data")
    public void setData(List<MultiPricedTransactionResponse> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this MultiPricedTransactionRes into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MultiPricedTransactionRes [" + "requestId=" + requestId + ", status=" + status
    ...
    /**
     * Builds a new {@link MultiPricedTransactionRes.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MultiPricedTransactionRes.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MultiPricedTransactionRes}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<MultiPricedTransactionResponse> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link MultiPricedTransactionRes} object using the set fields.
         * @return {@link MultiPricedTransactionRes}
         */
        public MultiPricedTransactionRes build() {
            return new MultiPricedTransactionRes(requestId, status, data, page, totalRecords,
                    totalPages, pageSize, warnings);
        }
    }
}
