...
/**
 * This is a model class for TransactionFeesRes type.
 */
public class TransactionFeesRes {
     ...
     * @param  data  List of FeeItem value for data.
    ...
    /**
     * Setter for Data.
     * @param data Value for List of FeeItem
     */
    @JsonSetter("Data")
    public void setData(List<FeeItem> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this TransactionFeesRes into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TransactionFeesRes [" + "requestId=" + requestId + ", status=" + status + ", data="
                + data + ", page=" + page + ", totalRecords=" + totalRecords + ", totalPages="
                + totalPages + ", pageSize=" + pageSize + ", warnings=" + warnings + "]";
    }

    /**
     * Builds a new {@link TransactionFeesRes.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TransactionFeesRes.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TransactionFeesRes}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<FeeItem> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link TransactionFeesRes} object using the set fields.
         * @return {@link TransactionFeesRes}
         */
        public TransactionFeesRes build() {
            return new TransactionFeesRes(requestId, status, data, page, totalRecords, totalPages,
                    pageSize, warnings);
        }
    }
}
