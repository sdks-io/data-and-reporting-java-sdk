...
/**
 * This is a model class for CardGroupRes type.
 */
public class CardGroupRes {
    private String requestId;
    private String status;
    private List<CardGroupResponseCardGroupsItems> data;
     ...
     * @param  data  List of CardGroupResponseCardGroupsItems value for data.
    ...
    public CardGroupRes(
            String requestId,
            String status,
            List<CardGroupResponseCardGroupsItems> data,
            Integer page,
    ...
    @JsonGetter("Data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<CardGroupResponseCardGroupsItems> getData() {
        return data;
    }

    /**
     * Setter for Data.
     * @param data Value for List of CardGroupResponseCardGroupsItems
     */
    @JsonSetter("Data")
    public void setData(List<CardGroupResponseCardGroupsItems> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this CardGroupRes into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CardGroupRes [" + "requestId=" + requestId + ", status=" + status + ", data=" + data
                + ", page=" + page + ", totalRecords=" + totalRecords + ", totalPages=" + totalPages
                + ", pageSize=" + pageSize + ", warnings=" + warnings + "]";
    }

    /**
     * Builds a new {@link CardGroupRes.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CardGroupRes.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CardGroupRes}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<CardGroupResponseCardGroupsItems> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link CardGroupRes} object using the set fields.
         * @return {@link CardGroupRes}
         */
        public CardGroupRes build() {
            return new CardGroupRes(requestId, status, data, page, totalRecords, totalPages,
                    pageSize, warnings);
        }
    }
}
