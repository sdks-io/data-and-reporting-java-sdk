...
/**
 * This is a model class for PricedTransactionResponseTransactionsItems type.
 */
public class PricedTransactionResponseTransactionsItems {
    ...
    protected PricedTransactionResponseTransactionsItems(OptionalNullable<String> type,
            ...
            OptionalNullable<Double> delCoExchangeRate, OptionalNullable<Double> colCoExchangeRate,
            OptionalNullable<Boolean> isShellSite, OptionalNullable<String> network,
            OptionalNullable<Integer> siteGroupId, OptionalNullable<String> siteGroupName,
            OptionalNullable<String> postingDate, OptionalNullable<String> issuerCode,
     ...
     * transactions Format: +/-HH:mm:ss (24 hours format) Note: - The value could be null/blank for
     * fees item.
     * @return Returns the Internal String
     */
     ...
     * Product Name Unleaded - High octane Unleaded - Medium octane Unleaded - Low octane Unleaded
     * Environmental
     * @return Returns the Internal String
     */
     ...
     * Effective Discount (excluding VAT, in transaction currency) 4 digits Example: 0.0000 Note: -
     * The value could be null/blank for fees item.
     * @return Returns the Internal Double
     */
     ...
     * Discount Type Example: 1-None 2-Pence per unit 3-Percentage Note: - The value could be
     * null/blank for fees item
     * @return Returns the Internal String
     */
     ...
     * Unit discount in customer currency. Example: 28.279000 Note: - The value could be null/blank
     * for fees item
     * @return Returns the Internal Double
     */
     ...
     * Exchange rate from transaction currency to customer currency. Example: 1 Note: - The value
     ...
     * Retail gross price (or gross pump price) in customer currency Retail net price (or net pump
    ...
    public String toString() {
        return "PricedTransactionResponseTransactionsItems [" + "type=" + type + ", cardId="
    ...
    /**
     * Builds a new {@link PricedTransactionResponseTransactionsItems.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PricedTransactionResponseTransactionsItems.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PricedTransactionResponseTransactionsItems}.
     */
    public static class Builder {
         ...
         */
        public PricedTransactionResponseTransactionsItems build() {
            return new PricedTransactionResponseTransactionsItems(type, cardId, cardPAN, cardExpiry,
                    transactionDate, transactionTime, uTCOffset, fleetIdInput, odometerInput,
                    driverName, vehicleRegistration, invoiceCurrencyCode, invoiceCurrencySymbol,
                    ...
                    fleetIDDescription, vATRate, vATCategory, vATCountry,
                    effectiveDiscountInTrxCurrency, transactionType, pINIndicator, vATApplicable,
                    netInvoiceIndicator, customerCurrencyCode, customerCurrencySymbol,
                    effectiveUnitDiscountInCustomerCurrency, effectiveDiscountInCustomerCurrency,
                    vATonNetAmountInCustomerCurrency, discountType, transactionStatus, salesItemId,
                    payerGroup, payerGroupName, refundFlag, originalSalesItemId, delcoName,
                    delcoCode, payerNumber, payerName, cardExpiryPeriod, authorisationCode,
                    transactionId, transactionLine, allowClearing, cRMNumber, disputeStatus,
                    rebateRate, delCoToColCoExchangeRate, netEuroAmount, euroRebateAmount,
                    euroVATAmount, parentCustomerNumber, parentCustomerName, parentCustomerId,
                    incomingSiteNumber, incomingSiteDescription, incomingCurrencyCode,
                    incomingProductCode, creditDebitCode, correctionFlag, additional1, additional2,
                    additional3, additional4, rebateonNetAmountInCustomerCurrency,
