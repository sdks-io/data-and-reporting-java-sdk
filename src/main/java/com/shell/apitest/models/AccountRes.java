...
/**
 * This is a model class for AccountRes type.
 */
public class AccountRes {
    private String requestId;
    private String status;
    private List<AccountResponseAccountsItems> data;
     ...
     * @param  data  List of AccountResponseAccountsItems value for data.
    ...
    public AccountRes(
            String requestId,
            String status,
            List<AccountResponseAccountsItems> data,
            Integer page,
    ...
    @JsonGetter("Data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<AccountResponseAccountsItems> getData() {
        return data;
    }

    /**
     * Setter for Data.
     * @param data Value for List of AccountResponseAccountsItems
     */
    @JsonSetter("Data")
    public void setData(List<AccountResponseAccountsItems> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this AccountRes into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountRes [" + "requestId=" + requestId + ", status=" + status + ", data=" + data
                + ", page=" + page + ", totalRecords=" + totalRecords + ", totalPages=" + totalPages
                + ", pageSize=" + pageSize + ", warnings=" + warnings + "]";
    }

    /**
     * Builds a new {@link AccountRes.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AccountRes.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AccountRes}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<AccountResponseAccountsItems> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link AccountRes} object using the set fields.
         * @return {@link AccountRes}
         */
        public AccountRes build() {
            return new AccountRes(requestId, status, data, page, totalRecords, totalPages, pageSize,
                    warnings);
        }
    }
}
