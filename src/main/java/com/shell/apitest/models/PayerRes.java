...
/**
 * This is a model class for PayerRes type.
 */
public class PayerRes {
    private String requestId;
    private String status;
    private List<PayerDetails> data;
     ...
     * @param  data  List of PayerDetails value for data.
    ...
    @JsonGetter("Data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<PayerDetails> getData() {
        return data;
    }

    /**
     * Setter for Data.
     * @param data Value for List of PayerDetails
     */
    @JsonSetter("Data")
    public void setData(List<PayerDetails> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this PayerRes into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PayerRes [" + "requestId=" + requestId + ", status=" + status + ", data=" + data
                + ", page=" + page + ", totalRecords=" + totalRecords + ", totalPages=" + totalPages
                + ", pageSize=" + pageSize + ", warnings=" + warnings + "]";
    }

    /**
     * Builds a new {@link PayerRes.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PayerRes.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PayerRes}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<PayerDetails> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link PayerRes} object using the set fields.
         * @return {@link PayerRes}
         */
        public PayerRes build() {
            return new PayerRes(requestId, status, data, page, totalRecords, totalPages, pageSize,
                    warnings);
        }
    }
}
