...
/**
 * This is a model class for PricedTransactionItemsLocationItems type.
 */
public class PricedTransactionItemsLocationItems {
    ...
    protected PricedTransactionItemsLocationItems(OptionalNullable<String> latitude,
     ...
     * Latitude for the Site Geographic Location Example: 37.4224764 Note: - The value could be
     ...
     * Longitude for the Site Geographic Location Example: 122.0842499 Note: - The value could be
     * null/blank for fees item.
     * @return Returns the Internal String
     */
    ...
    /**
     * Converts this PricedTransactionItemsLocationItems into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PricedTransactionItemsLocationItems [" + "latitude=" + latitude + ", longitude="
                + longitude + "]";
    }

    /**
     * Builds a new {@link PricedTransactionItemsLocationItems.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PricedTransactionItemsLocationItems.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PricedTransactionItemsLocationItems}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PricedTransactionItemsLocationItems} object using the set fields.
         * @return {@link PricedTransactionItemsLocationItems}
         */
        public PricedTransactionItemsLocationItems build() {
            return new PricedTransactionItemsLocationItems(latitude, longitude);
        }
    }
}
