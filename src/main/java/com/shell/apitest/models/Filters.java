...
public class Filters {
    ...
    protected Filters(String colCoCode, Object invoiceStatus, String payerNumber,
    ...
    public String toString() {
        return "Filters [" + "colCoCode=" + colCoCode + ", invoiceStatus=" + invoiceStatus
    ...
    public static class Builder {
        ...
        public Filters build() {
            return new Filters(colCoCode, invoiceStatus, payerNumber, accountId, accountNumber,
                    driverName, cardGroupId, cardPAN, productCode, productName, siteCode,
                    incomingSiteNumber, invoiceDate, invoiceNumber, purchasedInCountryCode,
                    purchasedInCountry, siteGroupId, vehicleRegistrationNumber, feeTypeId,
                    lineItemDescription, cards, sortOrder, fromDate, toDate, period,
                    postingDateFrom, postingDateTo, transactionItemId, fuelOnly, includeFees,
                    isMultipayer, validInvoiceDateOnly, invoiceFromDate, invoiceToDate,
                    hostingCollectingCompanyNumber, search, transactionId);
        }
    }
}
