...
public class Filters {
    ...
    protected Filters(String colCoCode, PricedTransactionReqV2InvoiceStatusEnum invoiceStatus,
            String payerNumber, Integer colCoId, OptionalNullable<Integer> accountId,
    ...
    public static class Builder {
        ...
        public Filters build() {
            return new Filters(colCoCode, invoiceStatus, payerNumber, colCoId, accountId,
