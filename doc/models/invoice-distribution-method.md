...
|  --- | --- | --- | --- | --- | --- |
| `IsPrimary` | `Boolean` | Optional | If True then this distribution method is the default distribution method.<br><br>**Default**: `true` | Boolean getIsPrimary() | setIsPrimary(Boolean isPrimary) |
