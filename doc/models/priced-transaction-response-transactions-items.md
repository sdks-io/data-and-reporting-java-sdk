...
| `Location` | [`List<PricedTransactionItemsLocationItems>`](../../doc/models/priced-transaction-items-location-items.md) | Optional | Geography Location entity for Site Location<br>Note: - The value could be null/blank for fees item | List<PricedTransactionItemsLocationItems> getLocation() | setLocation(List<PricedTransactionItemsLocationItems> location) |
