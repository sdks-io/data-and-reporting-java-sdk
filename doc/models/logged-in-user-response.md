...
| `IsSuperAdmin` | `Boolean` | Optional | Whether the user is a super administrator<br><br>**Default**: `false` | Boolean getIsSuperAdmin() | setIsSuperAdmin(Boolean isSuperAdmin) |
...
| `DisplayWeek` | `Boolean` | Optional | Preferred Display Week on Fuel Prices configuration for the logged in User.<br><br>**Default**: `true` | Boolean getDisplayWeek() | setDisplayWeek(Boolean displayWeek) |
...
| `HasAPIAccess` | `Boolean` | Optional | True/False<br>True, if user has access to the requested API. This is validated based on the role Vs API access matrix and client Vs API access matrix.<br><br>**Default**: `true` | Boolean getHasAPIAccess() | setHasAPIAccess(Boolean hasAPIAccess) |
