...
| `Data` | [`List<TransactionExceptionsResponse>`](../../doc/models/transaction-exceptions-response.md) | Optional | - | List<TransactionExceptionsResponse> getData() | setData(List<TransactionExceptionsResponse> data) |
