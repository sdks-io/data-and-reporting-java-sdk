...
|  --- | --- | --- | --- | --- | --- |
| `IncludePayerGroup` | `Boolean` | Optional | True/False. The output will include the payer group information only when true is passed.<br><br>**Default**: `false` | Boolean getIncludePayerGroup() | setIncludePayerGroup(Boolean includePayerGroup) |
| `IncludeEIDDetails` | `Boolean` | Optional | True/False. The output will include the EID (Electronic Invoice data) information only when true is passed..<br><br>**Default**: `false` | Boolean getIncludeEIDDetails() | setIncludeEIDDetails(Boolean includeEIDDetails) |
