...
| `InvoiceStatus` | [`PricedTransactionReqV2InvoiceStatusEnum`](../../doc/models/priced-transaction-req-v2-invoice-status-enum.md) | Required | **Constraints**: *Minimum Length*: `1`, *Maximum Length*: `1` | PricedTransactionReqV2InvoiceStatusEnum getInvoiceStatus() | setInvoiceStatus(PricedTransactionReqV2InvoiceStatusEnum invoiceStatus) |
| `PayerNumber` | `String` | Required | Payer Number of the selected payer.<br><br>**Constraints**: *Minimum Length*: `1` | String getPayerNumber() | setPayerNumber(String payerNumber) |
...
| `DriverName` | `String` | Optional | Driver Name (of Card record)<br><br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `40` | String getDriverName() | setDriverName(String driverName) |
...
| `ProductCode` | `String` | Optional | Product Code – Global as per GFN configuration<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `8` | String getProductCode() | setProductCode(String productCode) |
| `ProductName` | `String` | Optional | Product Name – Global as per GFN configuration<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `128` | String getProductName() | setProductName(String productName) |
| `SiteCode` | `String` | Optional | Site Code in GFN<br><br>**Constraints**: *Minimum Length*: `8`, *Maximum Length*: `87` | String getSiteCode() | setSiteCode(String siteCode) |
| `IncomingSiteNumber` | `String` | Optional | Site Code as configured in GFN<br><br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `10` | String getIncomingSiteNumber() | setIncomingSiteNumber(String incomingSiteNumber) |
...
| `InvoiceNumber` | `String` | Optional | Returns the billed transaction for the given invoice number<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `10` | String getInvoiceNumber() | setInvoiceNumber(String invoiceNumber) |
| `PurchasedInCountryCode` | `String` | Optional | Purchased InCountryCode<br><br>**Constraints**: *Minimum Length*: `2`, *Maximum Length*: `2` | String getPurchasedInCountryCode() | setPurchasedInCountryCode(String purchasedInCountryCode) |
...
| `VehicleRegistrationNumber` | `String` | Optional | Vehicle Registration (of Card record)<br><br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `128` | String getVehicleRegistrationNumber() | setVehicleRegistrationNumber(String vehicleRegistrationNumber) |
| `FeeTypeId` | `Integer` | Optional | Card Id (i.e. Unique Card Id in GFN) | Integer getFeeTypeId() | setFeeTypeId(Integer feeTypeId) |
| `LineItemDescription` | `String` | Optional | Item identifier in the transaction.<br><br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `128` | String getLineItemDescription() | setLineItemDescription(String lineItemDescription) |
| `Cards` | `List<Integer>` | Optional | This entity accepts the list of CardId to filter in the response.<br>Note: The number of cardId allowed to be passed in the request is configurable to a maximum of 500 cards.<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `500` | List<Integer> getCards() | setCards(List<Integer> cards) |
...
| `FuelOnly` | `Boolean` | Optional | Is FuelOnly indicator<br><br>**Default**: `false` | Boolean getFuelOnly() | setFuelOnly(Boolean fuelOnly) |
...
| `InvoiceFromDate` | `String` | Optional | Invoice From Date, this is a search criterion to filter invoiced transactions with invoice date from this date.<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `19` | String getInvoiceFromDate() | setInvoiceFromDate(String invoiceFromDate) |
| `InvoiceToDate` | `String` | Optional | Invoice To Date, this is a search criterion to filter invoiced transactions with invoice date until this date.<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `19` | String getInvoiceToDate() | setInvoiceToDate(String invoiceToDate) |
