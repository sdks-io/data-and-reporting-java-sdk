...
|  --- | --- | --- | --- | --- | --- |
| `Filters` | [`MultiPricedTransactionRequest`](../../doc/models/multi-priced-transaction-request.md) | Optional | - | MultiPricedTransactionRequest getFilters() | setFilters(MultiPricedTransactionRequest filters) |
