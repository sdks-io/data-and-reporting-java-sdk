...
| `Data` | [`List<MultiPricedTransactionResponse>`](../../doc/models/multi-priced-transaction-response.md) | Optional | - | List<MultiPricedTransactionResponse> getData() | setData(List<MultiPricedTransactionResponse> data) |
