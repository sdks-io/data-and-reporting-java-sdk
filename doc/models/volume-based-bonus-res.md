...
| `Data` | [`List<VolumeBasedBonusResponse>`](../../doc/models/volume-based-bonus-response.md) | Optional | - | List<VolumeBasedBonusResponse> getData() | setData(List<VolumeBasedBonusResponse> data) |
