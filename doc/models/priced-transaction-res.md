...
| `Data` | [`List<PricedTransactionResponse>`](../../doc/models/priced-transaction-response.md) | Optional | - | List<PricedTransactionResponse> getData() | setData(List<PricedTransactionResponse> data) |
