...
| `Data` | [`List<VolumeBasedPricingResponse>`](../../doc/models/volume-based-pricing-response.md) | Optional | - | List<VolumeBasedPricingResponse> getData() | setData(List<VolumeBasedPricingResponse> data) |
