...
| `Data` | [`List<StatementOfAccountResp>`](../../doc/models/statement-of-account-resp.md) | Optional | - | List<StatementOfAccountResp> getData() | setData(List<StatementOfAccountResp> data) |
