...
| `Data` | [`List<CardUsageSummaryResponse>`](../../doc/models/card-usage-summary-response.md) | Optional | - | List<CardUsageSummaryResponse> getData() | setData(List<CardUsageSummaryResponse> data) |
