...
| `Data` | [`List<AccountResponseAccountsItems>`](../../doc/models/account-response-accounts-items.md) | Optional | - | List<AccountResponseAccountsItems> getData() | setData(List<AccountResponseAccountsItems> data) |
