...
|  --- | --- | --- | --- | --- | --- |
| `IsDefault` | `Boolean` | Optional | Whether this payer is the default payer of the user.<br><br>**Default**: `false` | Boolean getIsDefault() | setIsDefault(Boolean isDefault) |
