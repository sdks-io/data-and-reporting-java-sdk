...
```java
CompletableFuture<CustomerPriceListResponse> customerPriceListAsync(
    final String apikey,
    final String requestId,
...
String apikey = "apikey6";
String requestId = "2b0cbe11-f109-4c43-9201-49af0370df1c";
CustomerPriceListRequest body = new CustomerPriceListRequest.Builder(
    "20230228",
    "20230228"
)
.build();

customerController.customerPriceListAsync(apikey, requestId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
