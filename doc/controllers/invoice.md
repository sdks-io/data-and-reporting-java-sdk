...
```java
CompletableFuture<StatementOfAccountResponse> statementOfAccountAsync(
    final String requestId,
...
```java
String requestId = "2b0cbe11-f109-4c43-9201-49af0370df1c";
StatementOfAccountRequest body = new StatementOfAccountRequest.Builder()
    .filters(new StatementOfAccountRequestFilters.Builder()
        .colCoCode(32)
        .payerId(308)
...
```java
CompletableFuture<SearchStatementOfAccountResponse> searchStatementOfAccountAsync(
    final String requestId,
...
```java
String requestId = "2b0cbe11-f109-4c43-9201-49af0370df1c";
SearchStatementOfAccountRequest body = new SearchStatementOfAccountRequest.Builder()
    .filters(new SearchSOAReq.Builder()
        .colCoCode(18)
