...
```java
CompletableFuture<PricedTransactionRes> pricedTransactionsAsync(
...
PriceTransactionReq body = new PriceTransactionReq.Builder()
    .page(1)
    .pageSize(100)
    .build();

transactionController.pricedTransactionsAsync(requestId, body).thenAccept(result -> {
...
```java
CompletableFuture<PricedTransSummaryResp> pricedTransactionsSummaryAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.pricedTransactionsSummaryAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<MultiPricedTransactionRes> multipricedTransactionsAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
MultiPricedTransactionReq body = new MultiPricedTransactionReq.Builder()
    .page(1)
    .pageSize(100)
    .build();

transactionController.multipricedTransactionsAsync(requestId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<CardUsageSummaryRes> cardUsageSummaryAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.cardUsageSummaryAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<VolumeBasedBonusRes> volumeBasedBonusAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.volumeBasedBonusAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<VolumeBasedPricingRes> volumeBasedPricingAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.volumeBasedPricingAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<TransactionFeesRes> feesAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
TransactionFeesReq body = new TransactionFeesReq.Builder()
    .page(1)
    .pageSize(100)
    .build();

transactionController.feesAsync(requestId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
String requestId = "RequestId8";
transactionController.feeSummaryResponseAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
String requestId = "RequestId8";
transactionController.fuelConsumptionAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<UpdateOdometerResp> updateOdometerAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.updateOdometerAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<TransactionExceptionsRes> transactionExceptionsAsync(
    final String requestId,
...
```java
String requestId = "RequestId8";
transactionController.transactionExceptionsAsync(requestId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
